      ...
      <div className="grid items-center grid-cols-3 pt-2 text-white">
        <div className="flex">
          <img
            ...
            className="xl:h-[125px] xl:w-[125px] h-[65px] w-[65px] object-cover"
          />

          <h1 className="content-center text-xl font-medium md:content-start lg:text-4xl font-poppins">
            INTERPROCSYS
          </h1>
        </div>
